...
\author{Lucas Pereira Machado}  % Seu nome
\authorbib{Pereira Machado, Lucas} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{FERRAMENTAS DE DESENVOLVIMENTO WEB: UMA ANÁLISE COMPARATIVA ENTRE OS PRINCIPAIS NAVEGADORES E SUAS APLICAÇÕES PRATICAS} % Título do trabalho
\titleen{ingles} % Título traduzido para inglês
\advisor{Prof. Me. Eduardo Pezutti Beletato dos Santos} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
...
\universitycampus{Campus Toledo}
...
%\evalboardmember{Fábio Engel de Camargo}{Doutor em Ciência da Computação}{Universidade Tecnológica Federal do Paraná}
%\evalboardmember{Ivan Luiz Salvadori}{Doutor em Ciência da Computação}{Universidade Tecnológica Federal do Paraná}
%\evalboardmember{Rosane Fátima Passarini}{Doutora em Engenharia de Automação e Sistemas	}{Universidade Tecnológica Federal do Paraná}
...
\NumeroDePalavrasChave{2}%% Número de palavras-chave (máximo 5)
...
\PalavraChaveA{Front-end}%% Palavra-chave A
\PalavraChaveB{Interação Humano Computador}%% Palavra-chave B
%\PalavraChaveC{}%% Palavra-chave C
%\PalavraChaveD{}%% Palavra-chave D
...
\NumeroDeKeywords{2}%% Número de keywords (máximo 5)
\KeywordA{Front-end}%% Keyword A
\KeywordB{Human Computer Interaction}%% Keyword B
%\KeywordC{}%% Keyword C
%\KeywordD{}%% Keyword D
